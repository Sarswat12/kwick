...
@RestController
@RequestMapping("/api/admin/kyc/debug")
public class KycDebugController {
    ...
    public KycDebugController(JdbcTemplate jdbcTemplate, DataSource dataSource,
    ...
    public ApiResponse<Map<String, Object>> env() {
        ...
        // Raw counts direct via SQL (helps detect schema/user issues)
